...
export default function Home() {
  ...
  // Base templates definition (20 Official Games)
  const templates = [
    { id: "esports", name: "Valorant", sub: "Ranked / K/D 2.5", universe: "Valorant", glow: "shadow-[#00d4ff]/10 border-[#00d4ff]/30", style: { background: "url('/banner_valorant_v2.jpg') center/cover no-repeat", color: "#ffffff" }, decor: null },
    { id: "minimalist", name: "Minecraft", sub: "Est. 2018", universe: "Minecraft", glow: "shadow-white/5 border-outline/30", style: { background: "url('/banner_minecraft_v2.jpg') center/cover no-repeat", color: "#ffffff" }, decor: null },
    { id: "streaming", name: "Fortnite", sub: "STREAMING NOW", universe: "Fortnite", glow: "shadow-[#8b5cf6]/10 border-[#8b5cf6]/30", style: { background: "url('/banner_fortnite_v2.jpg') center/cover no-repeat", color: "#ffffff" }, decor: null },
    { id: "cs2-tactical", name: "Call of Duty / CS2", sub: "TACTICAL LOADOUT", universe: "Call of Duty", glow: "shadow-[#de9b35]/10 border-[#de9b35]/30", style: { background: "url('/banner_cod_v2.jpg') center/cover no-repeat", color: "#ffffff" }, decor: null },
    { id: "gta-street", name: "GTA V / Roleplay", sub: "LOS SANTOS", universe: "GTA V", glow: "shadow-[#10b981]/10 border-[#10b981]/30", style: { background: "url('/banner_gtav_v2.jpg') center/cover no-repeat", color: "#ffffff" }, decor: null },
    { id: "modern-apex", name: "Apex Legends", sub: "Ranked Master", universe: "Apex Legends", glow: "shadow-[#ff3e3e]/10 border-[#ff3e3e]/30", style: { background: "url('/banner_apex_v2.jpg') center/cover no-repeat", color: "#ff3e3e" }, decor: null },
    { id: "rpg", name: "League of Legends", sub: "Lv 100 Mage", universe: "League of Legends", glow: "shadow-[#ffd8ae]/5 border-[#c8aa6e]/20", style: { background: "url('/banner_league_v2.jpg') center/cover no-repeat", color: "#dfc8a5" }, decor: null },
    { id: "rocket-league", name: "Rocket League", sub: "BOOST ON", universe: "Rocket League", glow: "shadow-[#00d4ff]/10 border-[#00d4ff]/30", style: { background: "url('/banner_rocketleague_v2.jpg') center/cover no-repeat", color: "#00d4ff" }, decor: null },
    { id: "pubg-mobile", name: "PUBG Mobile", sub: "Tactical Battlegrounds", universe: "PUBG Mobile", glow: "shadow-[#eab308]/10 border-[#eab308]/30", style: { background: "url('/banner_pubg_v2.jpg') center/cover no-repeat", color: "#eab308" }, decor: null },
    { id: "clash-of-clans", name: "Clash of Clans", sub: "Clan Leader", universe: "Clash of Clans", glow: "shadow-[#f59e0b]/10 border-[#f59e0b]/30", style: { background: "url('/banner_coc_v2.jpg') center/cover no-repeat", color: "#f59e0b" }, decor: null },
    { id: "forza-horizon", name: "Forza Horizon 5", sub: "Horizon Festival", universe: "Forza Horizon", glow: "shadow-[#f43f5e]/10 border-[#f43f5e]/30", style: { background: "url('/banner_forza_v2.jpg') center/cover no-repeat", color: "#f43f5e" }, decor: null },
    { id: "asphalt-9", name: "Asphalt 9", sub: "Legendary Driver", universe: "Asphalt 9", glow: "shadow-[#ec4899]/10 border-[#ec4899]/30", style: { background: "url('/banner_asphalt_v2.jpg') center/cover no-repeat", color: "#ec4899" }, decor: null },
    { id: "genshin-impact", name: "Genshin Impact", sub: "Traveler of Teyvat", universe: "Genshin Impact", glow: "shadow-[#38bdf8]/10 border-[#38bdf8]/30", style: { background: "url('/banner_genshin_v2.jpg') center/cover no-repeat", color: "#38bdf8" }, decor: null },
    { id: "roblox-virtual", name: "Roblox", sub: "Vibrant Virtual World", universe: "Roblox", glow: "shadow-[#ef4444]/10 border-[#ef4444]/30", style: { background: "url('/banner_roblox_v2.jpg') center/cover no-repeat", color: "#f43f5e" }, decor: null },
    { id: "fifa-soccer", name: "EA Sports FC 25", sub: "Ultimate Team", universe: "EA Sports FC", glow: "shadow-[#10b981]/10 border-[#10b981]/30", style: { background: "url('/banner_fifa_v2.jpg') center/cover no-repeat", color: "#10b981" }, decor: null },
    { id: "cyberpunk-2077", name: "Cyberpunk 2077", sub: "Night City Mercenary", universe: "Cyberpunk 2077", glow: "shadow-[#facc15]/10 border-[#facc15]/30", style: { background: "url('/banner_cyberpunk_v2.jpg') center/cover no-repeat", color: "#facc15" }, decor: null },
    { id: "elden-ring", name: "Elden Ring", sub: "Tarnished Lord", universe: "Elden Ring", glow: "shadow-[#fbbf24]/10 border-[#fbbf24]/30", style: { background: "url('/banner_eldenring_v2.jpg') center/cover no-repeat", color: "#fbbf24" }, decor: null },
    { id: "among-us", name: "Among Us", sub: "Spaceship Crewmate", universe: "Among Us", glow: "shadow-[#ef4444]/10 border-[#ef4444]/30", style: { background: "url('/banner_amongus_v2.jpg') center/cover no-repeat", color: "#ef4444" }, decor: null },
    { id: "clash-royale", name: "Clash Royale", sub: "Arena Challenger", universe: "Clash Royale", glow: "shadow-[#3b82f6]/10 border-[#3b82f6]/30", style: { background: "url('/banner_clashroyale_v2.jpg') center/cover no-repeat", color: "#3b82f6" }, decor: null },
    { id: "overwatch-hero", name: "Overwatch 2", sub: "HERO SELECT", universe: "Overwatch 2", glow: "shadow-[#f99e1a]/10 border-[#f99e1a]/30", style: { background: "url('/banner_overwatch_v2.jpg') center/cover no-repeat", color: "#f99e1a" }, decor: null },
  ];
