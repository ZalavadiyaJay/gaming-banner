...
export default function TwitchBanners() {
  ...
  const templates = [
    { id: "twitch-valorant", game: "valorant", bannerSlug: "tactical-offline-banner", name: "Valorant Radiant Offline", category: "Tactical", sub: "OFFLINE • Season 12 Live Soon", desc: "Tactical neon cyan offline screen for Valorant mains", textStyle: { fontFamily: "var(--font-gamertag)", fontStyle: "italic", color: "#00d4ff", textShadow: "0 0 10px #00d4ff, 0 0 20px #00d4ff, 0 0 40px #005f73", letterSpacing: "0.15em" }, style: { background: "url('/twitch_valorant.jpg') center/cover no-repeat" } },
    { id: "twitch-cod", game: "call-of-duty", bannerSlug: "warzone-offline-banner", name: "Warzone Tactical Offline", category: "FPS", sub: "STARTING SOON • Mon-Fri 8PM", desc: "Gunmetal grid overlay for tactical Warzone streams", textStyle: { fontFamily: "Impact, sans-serif", color: "#ffffff", textShadow: "3px 3px 0px #1e293b, -3px -3px 0px #1e293b, 3px -3px 0px #1e293b, -3px 3px 0px #1e293b", letterSpacing: "0.05em" }, style: { background: "url('/twitch_cod.jpg') center/cover no-repeat" } },
    { id: "twitch-fortnite", game: "fortnite", bannerSlug: "rift-royale-offline-banner", name: "Fortnite Royale Offline", category: "Battle Royale", sub: "OFFLINE • Follow for Rank Push", desc: "Purple rift sky offline card for Battle Royale content", textStyle: { fontFamily: "var(--font-sans)", fontWeight: "900", color: "#ffffff", textShadow: "0 0 10px #c084fc, 0 0 20px #8b5cf6, 0 0 30px #6d28d9", letterSpacing: "0.08em" }, style: { background: "url('/twitch_fortnite.jpg') center/cover no-repeat" } },
    { id: "twitch-minecraft", game: "minecraft", bannerSlug: "cozy-voxel-offline-banner", name: "Minecraft Voxel Offline", category: "Sandbox", sub: "BE RIGHT BACK • Building spawn", desc: "Cozy voxel sunset card for creative and survival modes", textStyle: { fontFamily: "var(--font-data-mono)", color: "#10b981", textShadow: "2px 2px 0px #064e3b, 4px 4px 0px #022c22", letterSpacing: "0.1em" }, style: { background: "url('/twitch_minecraft.jpg') center/cover no-repeat" } },
    { id: "twitch-apex", game: "apex-legends", bannerSlug: "predator-offline-banner", name: "Apex Predator Offline", category: "Battle Royale", sub: "STREAMING SOON • Predator Grind", desc: "Volcanic hazard orange background for high-tier Apex content", textStyle: { fontFamily: "var(--font-gamertag)", fontStyle: "italic", color: "#ff3e3e", textShadow: "0 0 8px #ea580c, 3px 3px 0px #000000", letterSpacing: "0.05em" }, style: { background: "url('/twitch_apex.jpg') center/cover no-repeat" } },
    { id: "twitch-gtav", game: "gta-v", bannerSlug: "los-santos-rp-offline-banner", name: "GTA RP Offline", category: "Roleplay", sub: "OFFLINE • Back at 7PM EST", desc: "Los Santos skyline retro purple glow for GTA RP streams", textStyle: { fontFamily: "var(--font-gamertag)", fontStyle: "italic", color: "#f472b6", textShadow: "0 0 10px #f472b6, 0 0 20px #db2777, 0 0 30px #00d4ff", letterSpacing: "0.12em" }, style: { background: "url('/twitch_gtav.jpg') center/cover no-repeat" } },
    { id: "twitch-league", game: "league-of-legends", bannerSlug: "challenger-offline-banner", name: "League Challenger Offline", category: "MOBA", sub: "STARTING SOON • Mid Lane Carry", desc: "Magical golden rune lines for League of Legends rank push", textStyle: { fontFamily: "Georgia, serif", color: "#dfc8a5", textShadow: "0 2px 4px #78350f, 0 0 12px rgba(223, 200, 165, 0.4)", letterSpacing: "0.2em" }, style: { background: "url('/twitch_league.jpg') center/cover no-repeat" } },
    { id: "twitch-rocketleague", game: "rocket-league", bannerSlug: "grand-champ-offline-banner", name: "Rocket League Offline", category: "Sports Action", sub: "BE RIGHT BACK • Grand Champ ELO", desc: "Cyber dome stadium lights for Rocket League speed runs", textStyle: { fontFamily: "var(--font-gamertag)", color: "#06b6d4", textShadow: "0 0 15px #06b6d4, 0 0 25px #0891b2, 2px 2px 0px #000000", letterSpacing: "0.15em" }, style: { background: "url('/twitch_rocketleague.jpg') center/cover no-repeat" } },
    ...
    { id: "twitch-roblox", game: "roblox", bannerSlug: "metaverse-offline-banner", name: "Roblox Offline", category: "Sandbox", sub: "STREAMING SOON • Custom Mini-games", desc: "Design a colorful Roblox Metaverse Parkour offline screen", textStyle: { fontFamily: "var(--font-sans)", fontWeight: "900", color: "#ef4444", textShadow: "4px 4px 0px #7f1d1d, 8px 8px 12px rgba(0,0,0,0.8)", letterSpacing: "0.05em" }, style: { background: "url('/twitch_roblox.jpg') center/cover no-repeat" } },
    { id: "twitch-cyberpunk", game: "cyberpunk-2077", bannerSlug: "netrunner-offline-banner", name: "Cyberpunk Offline", category: "Action RPG", sub: "STARTING SOON • Netrunner Build", desc: "Create a futuristic Cyberpunk 2077 Netrunner offline banner", textStyle: { fontFamily: "Impact, sans-serif", color: "#facc15", textShadow: "3px 3px 0px #000000, -3px -3px 0px #000000, 0 0 15px #facc15", letterSpacing: "0.1em" }, style: { background: "url('/twitch_cyberpunk.jpg') center/cover no-repeat" } },
    { id: "twitch-eldenring", game: "elden-ring", bannerSlug: "erdtree-offline-banner", name: "Elden Ring Offline", category: "Action RPG", sub: "OFFLINE • Rune Level 1 runs", desc: "Design a somber Elden Ring Shadow of the Erdtree offline banner", textStyle: { fontFamily: "Georgia, serif", color: "#fbbf24", textShadow: "0 2px 8px #78350f, 0 0 20px #b45309", letterSpacing: "0.25em" }, style: { background: "url('/twitch_eldenring.jpg') center/cover no-repeat" } },
    { id: "twitch-amongus", game: "among-us", bannerSlug: "emergency-offline-banner", name: "Among Us Offline", category: "Party", sub: "BE RIGHT BACK • Who is Impostor?", desc: "Create a playful Among Us Skeld Spaceship offline banner", textStyle: { fontFamily: "var(--font-sans)", fontWeight: "900", color: "#ef4444", textShadow: "3px 3px 0px #000, -3px -3px 0px #000, 3px -3px 0px #000, -3px 3px 0px #000", letterSpacing: "0.08em" }, style: { background: "url('/twitch_amongus.jpg') center/cover no-repeat" } },
    { id: "twitch-clashroyale", game: "clash-royale", bannerSlug: "trophy-push-offline-banner", name: "Clash Royale Offline", category: "Strategy", sub: "OFFLINE • Midladder Trophy Push", desc: "Design a competitive Clash Royale Arena Champions offline banner", textStyle: { fontFamily: "var(--font-sans)", fontWeight: "900", color: "#3b82f6", textShadow: "0 3px 0px #1d4ed8, 0 6px 0px #1e3a8a, 0 10px 12px rgba(0,0,0,0.8)", letterSpacing: "0.1em" }, style: { background: "url('/twitch_clashroyale.jpg') center/cover no-repeat" } },
    { id: "twitch-overwatch", game: "overwatch-2", bannerSlug: "comp-grind-offline-banner", name: "Overwatch Offline", category: "Hero Shooter", sub: "OFFLINE • Comp Grind Tomorrow", desc: "Create a dynamic Overwatch 2 Rooftop Heroes offline banner", textStyle: { fontFamily: "Impact, sans-serif", color: "#f99e1a", textShadow: "0 2px 0px #78350f, 0 4px 0px #451a03, 0 8px 12px rgba(0,0,0,0.8)", letterSpacing: "0.05em" }, style: { background: "url('/twitch_overwatch.jpg') center/cover no-repeat" } },
    { id: "twitch-fifa", game: "ea-sports-fc", bannerSlug: "fut-champions-offline-banner", name: "FC 24 Offline", category: "Sports", sub: "OFFLINE • FUT Champions Weekend", desc: "Design a premier EA Sports FC 25 Pitch Floodlights offline banner", textStyle: { fontFamily: "var(--font-gamertag)", color: "#10b981", textShadow: "0 0 10px #10b981, 0 0 20px #047857, 2px 2px 0px #000000", letterSpacing: "0.15em" }, style: { background: "url('/twitch_fifa.jpg') center/cover no-repeat" } }
  ];
